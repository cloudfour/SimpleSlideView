(function() {
  ...
  defaults = {
    ...
    scrollCallback: $.scrollTo != null ? 'scrollTo' : false,
    scrollOn: 'end',
  ...
  SimpleSlideView = (function() {
    ...
    SimpleSlideView.prototype.changeView = function(targetView, action) {
      var $bothViews, $targetView, animateHeight, args, changeComplete, containerWidth, inAnimProps, outAnimProps, resetProps, transformProp, translateAfter, translateBefore,
        _this = this;
      if (action == null) {
        action = 'push';
      }
