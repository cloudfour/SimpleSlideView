(function() {
  ...
  SimpleSlideView = (function() {
    ...
    SimpleSlideView.prototype.changeView = function(targetView, action) {
      var $bothViews, $targetView, animateHeight, animateHeightCallback, containerWidth, eventArgs, inAnimProps, maxTop, outAnimProps, resetProps, transformProp, translateAfter, translateBefore,
        _this = this;
      if (action == null) {
        action = 'push';
      }
