(function($, window) {
  ...
  scrollCallback = $.scrollTo != null ? function(top, duration, callback) {
    return $.scrollTo(top, duration, {
      'axis': 'y',
      'onAfter': callback
    });
  } : function(top, duration, callback) {
  ...
  SimpleSlideView = (function() {
    ...
    SimpleSlideView.prototype.on = function() {
      ...
      if (this.options.dataAttrEvent != null) {
        this.$container.on(this.options.dataAttrEvent, '[data-' + this.options.dataAttr.push + ']', (function(_this) {
        ...
        this.$container.on(this.options.dataAttrEvent, '[data-' + this.options.dataAttr.pop + ']', (function(_this) {
          return function(event) {
            var $el, target;
            $el = $(event.currentTarget);
  ...
  return $.fn.simpleSlideView = function(options, extras) {
    if (options == null) {
      options = {};
    }
