...
(function($, window, Modernizr) {
  ...
  SimpleSlideView = (function() {
    ...
    SimpleSlideView.prototype.changeView = function(target, action) {
      ...
      // State and events
      this.isSliding = true;
      this.$container.trigger(this.options.eventNames.viewChangeStart, [$targetView, action]);
      ...
      onScrollEnd = $.proxy(function() {
        this.isSliding = false;
        this.$container.trigger(this.options.eventNames.viewChangeEnd, $targetView, action);
