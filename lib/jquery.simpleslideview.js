...
(function() {
  ...
  SimpleSlideView = (function() {
    ...
    SimpleSlideView.prototype.changeView = function(targetView, push) {
      var $bothViews, $targetView, animateHeight, animateHeightCallback, containerWidth, inAnimProps, outAnimProps, resetProps, transformProp, translateAfter, translateBefore,
        _this = this;
