  ...
  $.SimpleSlideView = function(options) {
    ...
    actions = {
      ...
      on: function() {
        ...
        $container.on("touchstart mousedown", "[data-pushview]", function(event) {
          event.preventDefault();
          return actions.pushView($(this).data("pushview"));
        });
        $container.on("touchstart mousedown", "[data-popview]", function(event) {
          event.preventDefault();
          return actions.popView($(this).data("popview"));
        });
        $container.on("click", "[data-pushview]", function(e) {
          return e.preventDefault();
        });
        return $container.on("click", "[data-popview]", function(e) {
          return e.preventDefault();
        });
      },
      off: function() {
